            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
              ...
              with font-awesome or any other icon font library -->
                <li class="nav-item has-treeview menu-open">
                    <a href="./inicio.php" class="nav-link" aria-pressed="true">
                ...
                <li class="nav-item">
                    <a href="./pqs.php" class="nav-link" aria-pressed="true">
                ...
                <li class="nav-item">
                    <a href="./areauditoria.php" class="nav-link" aria-pressed="true">
