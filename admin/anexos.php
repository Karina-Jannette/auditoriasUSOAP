        ...
        <div class="content-wrapper">
            ...
            <div class="menu">
                <ul class="nav nav-tabs justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link anexos" id="menanexos" href="#1" type="button"
                            onclick="mostrar_ocultar()">Anexos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fracciones" id="menfracciones" href="#2" type="button"
                            onclick="mos_oculFra()">Fracciones</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link sub_fracciones" id="mensub_fraccion" href="#3" type="button"
                            onclick="mos_oculSub()">Sub
                            fracciones</a>
                    </li>
                </ul>
            </div>
                            ...
                            <table id="tablaFra" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button class="btn btn-success btnEditarFra"
                                                data-target="#EditarFraccion" data-toggle="modal"
